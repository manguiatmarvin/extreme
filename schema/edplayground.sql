...
--
-- Host: localhost
-- Generation Time: Nov 11, 2014 at 11:17 PM
...
CREATE TABLE IF NOT EXISTS `employee_feedback` (
  ...
  `type` int(11) NOT NULL COMMENT 'type is 1 or 0 positive and negative',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11 ;
...
INSERT INTO `employee_feedback` (`id`, `feedback`, `create_date`, `from_user_id`, `to_employee_id`, `type`) VALUES
(1, 'Marvin lifted the toilet seat ', '2014-11-07 02:12:09', 12, 1, 1),
(2, 'Marvin fixed my computer problem for free', '2014-11-05 00:00:00', 12, 1, 1),
(3, 'Marvin did some nice logo for my websites', '2014-11-07 05:08:10', 14, 1, 1),
(4, 'Marvin hacked my computer ', '2014-11-07 03:06:15', 13, 1, 0),
(5, 'Marvin introduced a bug on sms', '2014-11-07 00:00:00', 17, 1, 0),
(6, 'Marvin did a good job on my website, i will def hire him again in the future. ', '2014-11-10 02:04:06', 13, 1, 1),
(7, 'Great job on my websites ', '2014-11-10 00:00:00', 18, 1, 1),
(8, 'On time delivery, quality output \r\nthis guy is a pro ', '2014-11-10 00:00:00', 19, 1, 1),
(9, 'Edgar is a Superman!', '2014-11-10 00:00:00', 18, 2, 1),
(10, 'Edgar shared some useful tools for managing linux server', '2014-11-10 01:01:03', 17, 2, 1);
...
(19, 1, 0, '2014-11-10 00:47:46', '192.168.4.167'),
(20, 8, 0, '2014-11-10 22:31:58', '192.168.4.167'),
(21, 4, 0, '2014-11-11 01:49:56', '192.168.4.167'),
(22, 2, 0, '2014-11-11 02:09:50', '192.168.4.167');
...
(1, 'basic brain test', 100, 1, '2014-11-05 00:49:03', '2014-11-05 00:49:03'),
(2, 'Java Object Oriented Programming Basic', 86, 1, '2014-11-10 22:03:09', '2014-11-10 22:03:09'),
...
--
-- Table structure for table `points_matrix`
--

CREATE TABLE IF NOT EXISTS `points_matrix` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `point_name` varchar(175) NOT NULL,
...
--
-- Dumping data for table `points_matrix`
--

INSERT INTO `points_matrix` (`id`, `point_name`, `point`, `created`) VALUES
(1, 'Perfect Attendance', 2, '2014-11-07 14:46:11'),
(2, 'Less than 2 absences ', 1, '2014-11-07 14:46:11'),
(3, 'Perfect System Logging ', 5, '2014-11-07 14:46:11'),
(4, 'No Undertime', 1, '2014-11-07 14:46:11');
...
(20, 'admin', 'admin', 'admin@sourcefit.com', 'admin'),
(21, 'employee', 'employee', 'employee@sourcefit.com', 'employee');
...
(17, 18, 'Brad', 'Hunter', 'c', '0000-00-00', 0, '', '', '', '', '0000-00-00', '0000-00-00 00:00:00', ''),
(18, 19, 'Karen', 'Capaciti', '', '0000-00-00', 0, '', '', '', '', '0000-00-00', '0000-00-00 00:00:00', ''),
(19, 20, 'admin', 'admin', 'a', '1983-12-06', 1, 'w', '45454545', '45454545', 'w', '0000-00-00', '2014-11-10 22:28:42', '/img/avatar/user20.png'),
(20, 21, 'employee', 'employee', 'e', '2000-11-30', 2, 'employee', '3453435434', '34343434', 'employee', '0000-00-00', '2014-11-10 22:31:54', '/img/avatar/user21.png');
