...
public class Convert {
	...
	public Boolean startConvert() {
		this.pb = new ProcessBuilder("ffmpeg", "-i", this.getVsource(), "-c:v",
				"libx264", "-s", "320x240", "-strict", "experimental", "-c:a",
				"aac", "-b:a", "32k", this.getVdestination(), "-y");
		...
		double totalSecs = Integer.parseInt(hms[0]) * 3600
				+ Integer.parseInt(hms[1]) * 60 + Double.parseDouble(hms[2]);
	...
	public String createThumbnail() {
		this.pb = new ProcessBuilder("ffmpeg", "-i", this.getVdestination(),
				"-ss", "00:00:30.435", "-f", "image2", "-vframes", "1", "-s",
				"160x120", this.getThumbnail1(), "-y");
